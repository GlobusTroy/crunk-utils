# ReceptorControlComponent.gd
class_name ReceptorControlComponent
extends Node
## Component stub that registers its parent Control as a drop receptor with the DragDropEventBus.
##
## Attach as a child of any Control to mark it as a valid drop target.
## Drop behaviour is implemented in DragDropEventBus; this component handles
...
func _exit_tree() -> void:
	...
	if bus:
		...
		bus.unregister_receptor(_parent_control)
