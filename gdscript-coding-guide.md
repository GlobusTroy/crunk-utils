...
- Use MCP to refer to documentation for best practices before using builtin classes
- Minimize coupled code and classes, enforce separation of concerns and single responsibility principle
...
- Review existing classes in project for reuse rather than duplicating functionality
